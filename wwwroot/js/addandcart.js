// ============================================================
//  addandcart.js - Giỏ hàng (gọi API backend tại /api/cart)
...
async function addToCart(e) {
  ...
  const res = await fetch(CART_API, { method: "POST", body: fd, credentials: "include" });
...
async function openCart() {
  const res = await fetch(CART_API + "?action=get", { credentials: "include" });
  const data = await res.json();
        ...
        <div class="cart-popup">
            <div class="cart-header">
                ...
                <div class="cart-header-actions">
                    <a href="/my_orders" class="orders-link">📋 Lịch sử đơn hàng</a>
